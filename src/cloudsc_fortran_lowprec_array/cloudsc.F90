...
SUBROUTINE CLOUDSC &
 ...
 & PTSPHY,&
 & PT, PQ, &
 & PTENDENCY_TMP_T, PTENDENCY_TMP_Q, PTENDENCY_TMP_A, PTENDENCY_TMP_CLD, PTENDENCY_TMP_CLD_SCALE, &
 & PTENDENCY_LOC_T, PTENDENCY_LOC_Q, PTENDENCY_LOC_A, PTENDENCY_LOC_CLD, PTENDENCY_LOC_CLD_SCALE, &
...
REAL(KIND=JPRB)   ,INTENT(INOUT)   :: PTENDENCY_TMP_CLD_SCALE
...
REAL(KIND=JPRB)   ,INTENT(INOUT)   :: PTENDENCY_LOC_CLD_SCALE
...
REAL(KIND=rp)   ,INTENT(IN)    :: PCLV(KLON,KLEV,NCLV) 
REAL(KIND=JPRB)   ,INTENT(IN)   :: PCLV_SCALE
...
DO JM=1,NCLV-1
  DO JK=1,KLEV
    DO JL=KIDIA,KFDIA
      PTENDENCY_LOC_CLD(JL,JK,JM)=0.0_rp
    ENDDO
  ENDDO
ENDDO
...
DO JM=1,NCLV-1
  DO JK=1,KLEV
    DO JL=KIDIA,KFDIA
      ZQX(JL,JK,JM)  = PCLV_SCALE*PCLV(JL,JK,JM) + PTSPHY*PTENDENCY_TMP_CLD(JL,JK,JM)*PTENDENCY_TMP_CLD_SCALE
      ZQX0(JL,JK,JM) = PCLV_SCALE*PCLV(JL,JK,JM) + PTSPHY*PTENDENCY_TMP_CLD(JL,JK,JM)*PTENDENCY_TMP_CLD_SCALE
    ENDDO
  ENDDO
ENDDO
...
!DIR$ PREFERVECTOR
  ...
  DO JM=1,NCLV-1
    ...
    ENDIF
      ...
      !----------------------------------------------------------------------
    DO JL=KIDIA,KFDIA
      PTENDENCY_LOC_CLD(JL,JK,JM) = PTENDENCY_LOC_CLD(JL,JK,JM) + (ZQXN(JL,JM)-ZQX0(JL,JK,JM))*ZQTMST/PTENDENCY_LOC_CLD_SCALE
    ENDDO
