...
ASSOCIATE(LAERICEAUTO=>YRECLDP%LAERICEAUTO, LAERICESED=>YRECLDP%LAERICESED, &
 ...
 & RG=>YDCST%RG, RD=>YDCST%RD, RCPD=>YDCST%RCPD, RETV=>YDCST%RETV, &
 & RLVTT=>YDCST%RLVTT, RLSTT=>YDCST%RLSTT, RLMLT=>YDCST%RLMLT, &
 & RTT=>YDCST%RTT, RV=>YDCST%RV, &
 & R2ES=>YDTHF%R2ES, R3LES=>YDTHF%R3LES, R3IES=>YDTHF%R3IES, &
 & R4LES=>YDTHF%R4LES, R4IES=>YDTHF%R4IES, R5LES=>YDTHF%R5LES, &
 & R5IES=>YDTHF%R5IES, R5ALVCP=>YDTHF%R5ALVCP, R5ALSCP=>YDTHF%R5ALSCP, &
 & RALVDCP=>YDTHF%RALVDCP, RALSDCP=>YDTHF%RALSDCP, &
 & RALFDCP=>YDTHF%RALFDCP, RTWAT=>YDTHF%RTWAT, RTICE=>YDTHF%RTICE, &
 & RTICECU=>YDTHF%RTICECU, RTWAT_RTICE_R=>YDTHF%RTWAT_RTICE_R, &
 & RTWAT_RTICECU_R=>YDTHF%RTWAT_RTICECU_R, RKOOP1=>YDTHF%RKOOP1, &
 & RKOOP2=>YDTHF%RKOOP2 &
 & )
