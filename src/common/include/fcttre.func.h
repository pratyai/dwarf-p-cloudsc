...
FOEDELTA (PTARE) = MAX (0.0_JPRL,REAL(SIGN(1.0_JPRD,REAL(PTARE-RTT,JPRD)),JPRL))
...
FOEEW ( PTARE ) = R2ES*EXP (REAL(&
  &(R3LES*FOEDELTA(PTARE)+R3IES*(1.0_JPRL-FOEDELTA(PTARE)))*(PTARE-RTT)&
&/ (PTARE-(R4LES*FOEDELTA(PTARE)+R4IES*(1.0_JPRL-FOEDELTA(PTARE)))), JPRD))
...
FOEEWM ( PTARE ) = R2ES *&
     &(FOEALFA(PTARE)*EXP(REAL(R3LES*(PTARE-RTT)/(PTARE-R4LES), JPRD))+&
  &(1.0_JPRL-FOEALFA(PTARE))*EXP(REAL(R3IES*(PTARE-RTT)/(PTARE-R4IES), JPRD)))

FOE_DEWM_DT( PTARE ) = R2ES * ( &
     & R3LES*FOEALFA(PTARE)*EXP(REAL(R3LES*(PTARE-RTT)/(PTARE-R4LES), JPRD)) &
     &    *(RTT-R4LES)/(PTARE-R4LES)**2 + &
     & R3IES*(1.0_JPRL-FOEALFA(PTARE))*EXP(REAL(R3IES*(PTARE-RTT)/(PTARE-R4IES), JPRD)) &
...
FOEEWMCU ( PTARE ) = R2ES *&
     &(FOEALFCU(PTARE)*EXP(REAL(R3LES*(PTARE-RTT)/(PTARE-R4LES), JPRD))+&
  &(1.0_JPRL-FOEALFCU(PTARE))*EXP(REAL(R3IES*(PTARE-RTT)/(PTARE-R4IES), JPRD)))
...
FOEEWMO( PTARE ) = R2ES*EXP(REAL(R3LES*(PTARE-RTT)/(PTARE-R4LES), JPRD))
FOEELIQ( PTARE ) = R2ES*EXP(REAL(R3LES*(PTARE-RTT)/(PTARE-R4LES), JPRD))
FOEEICE( PTARE ) = R2ES*EXP(REAL(R3IES*(PTARE-RTT)/(PTARE-R4IES), JPRD))
