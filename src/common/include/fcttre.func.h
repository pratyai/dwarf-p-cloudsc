...
FOEDELTA (PTARE) = MAX (0.0_JPRL,SIGN(1.0_JPRL,PTARE-RTT))
...
&/ (PTARE-(R4LES*FOEDELTA(PTARE)+R4IES*(1.0_JPRL-FOEDELTA(PTARE)))))
...
FOEEWM ( PTARE ) = R2ES *&
  ...
  &(1.0_JPRL-FOEALFA(PTARE))*EXP(R3IES*(PTARE-RTT)/(PTARE-R4IES)))

FOE_DEWM_DT( PTARE ) = R2ES * ( &
     & R3LES*FOEALFA(PTARE)*EXP(R3LES*(PTARE-RTT)/(PTARE-R4LES)) &
     &    *(RTT-R4LES)/(PTARE-R4LES)**2 + &
     & R3IES*(1.0_JPRL-FOEALFA(PTARE))*EXP(R3IES*(PTARE-RTT)/(PTARE-R4IES)) &
...
FOEEWMCU ( PTARE ) = R2ES *&
  ...
  &(1.0_JPRL-FOEALFCU(PTARE))*EXP(R3IES*(PTARE-RTT)/(PTARE-R4IES)))
