...
MODULE CLOUDSC_GLOBAL_STATE_MOD
  ...
  USE EXPAND_MOD, ONLY: LOAD_AND_EXPAND, LOAD_AND_EXPAND_STATE, LOAD_AND_EXPAND_R2_DPRD
...
!$omp end parallel do 
  ...
  SUBROUTINE CLOUDSC_GLOBAL_STATE_LOAD(SELF, NPROMA, NGPTOT, NGPTOTG)
    ...
    ! SC2026: JPRD temp buffers — JPRB (FP16) would overflow for pressure values > 65504 Pa
